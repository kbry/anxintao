package android.com.anxintao.widget.banner;
        ...
        if (viewList != null && viewList.size() != 0) {
            if (mLinearPosition.getChildCount() != viewSize) {
                ...
                for (int i = 0; i < diffCnt; i++) {
                    if (needAdd) {
                        ...
                        img.setBackgroundResource(R.drawable.banner_point_normal);
            ...
            for (int i = 0; i < mLinearPosition.getChildCount(); i++) {
                if (i == (curPos % viewSize)) {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.banner_point_selected);
                } else {
                    mLinearPosition.getChildAt(i).setBackgroundResource(R.drawable.banner_point_normal);
                }
            }
        }
    }
